...
VARIABLES = f'''
    ...
    "TRIGGER_EXAMPLE_1_DESCRIPTION to TRIGGER_EXAMPLE_4_DESCRIPTION": "Descriptions of specific triggers.",
    "TRIGGER_EXAMPLE_5_NEUROSCIENCE_CONNECTION": "An example of a trigger with a neuroscientific connection, if applicable.",
    "CLICHE_PHRASE_EXAMPLE_1 to CLICHE_PHRASE_EXAMPLE_3": "Examples of cliché phrases to avoid in the niche.",
    ...
    "PREFERRED_CONTENT_ELEMENT_1 to PREFERRED_CONTENT_ELEMENT_7": "Content elements to prioritize (e.g., inspiring metaphors, case studies, practical exercises).",
    ...
    "STYLE_INGREDIENT_1 to STYLE_INGREDIENT_5": "Components that form the channels unique style.",
    ...
    "TOPIC_STRUCTURE_STEP1_DESCRIPTION to TOPIC_STRUCTURE_STEP6_DESCRIPTION": "Descriptions for each step of the development topic structure (e.g., Step 1: A magnetizing phrase that blends curiosity, emotion, and impact.).",
    ...
    "STYLE_REFERENCE_PERSON_1 and _2, _3)": People who are style references.",
    "STYLE_REFERENCE_PERSON_1_FOCUS and _2, _3)": The focus/specialty of this reference person.",
