...
def run(expressions_path, more_than_1_expression, subtitles_with_expressions, duration, position_h=-200, position_v='center', expressions_size=1.2):
    print("\t\t- Building the expressions videofile...")
    
    if more_than_1_expression:
        image_clips = []
        for entry in subtitles_with_expressions:
            ...
            if not os.path.exists(image_path):
                image_path = os.path.join(expressions_path, "serious.png")
